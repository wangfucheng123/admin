	...
	<script type="text/javascript">
		var setting = {
			...
			function addHoverDom(treeId, treeNode) {
				...
				var dsc = "<span class='button desc' id='dscBtn_"
							+ treeNode.tId
				...
				if (btn)
					btn.bind("click", function() {
						...
						comm('rightTree/saveTree?parentId=' + treeNode.id
								+ '&name=' + encodeURI(encodeURI('新节点'))+ '&code=code'  );
...
<body> 
	...
	<script type="text/javascript">
		function addTr(){
			...
			var tr='<tr id="tr'+i+'"><td><input name="limits'+i+'"  id="limits'+i+'" type="text"  />年</td><td><input name="price'+i+'" onBlur="onBlura(this)" id="price'+i+'" type="text"  /></td>'
