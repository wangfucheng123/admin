...
<body>
	...
	{
	%>
    <li><label>用户密码</label><input name="password" id="password" type="password" class="dfinput" /></li>
    <%} %>
    ...
    <li><label>&nbsp;</label><input name="" onclick="javascript:save('edtForm','user/saveAdminUser')" type="button" class="btn" value="确认保存"/></li>
    </ul>
    </form>
    </div>
</body>
